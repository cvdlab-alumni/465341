...
var house1 = COLOR(WHITE)(CUBOID([2,2,2]));

var domain = PROD1x1([INTERVALS(1)(16),INTERVALS(1)(16)]);
var c0 = BEZIER(S0)([[0,0,2],[2,0,2]]);
var c1 = BEZIER(S0)([[0,1,3],[2,1,3]]);
var out = COLOR(LIGHTRED)(MAP(BEZIER(S1)([c0,c1]))(domain));
var c2 = BEZIER(S0)([[0,2,2],[2,2,2]]);
var c3 = BEZIER(S0)([[0,1,3],[2,1,3]]);
var out2 = COLOR(LIGHTRED)(MAP(BEZIER(S1)([c2,c3]))(domain));
var c4 = BEZIER(S0)([[0,0,2],[0,1,3]]);
var out3 = COLOR(LIGHTRED)(MAP(BEZIER(S1)([c4,[0,2,2]]))(domain));
var c5 = BEZIER(S0)([[2,0,2],[2,1,3]]);
var out4 = COLOR(LIGHTRED)(MAP(BEZIER(S1)([c5,[2,2,2]]))(domain));
var house = STRUCT([house1,out,out2,out3,out4])
var housescalata= SCALE([0,1,2])([0.5,0.5,0.5])(house)
var housetraslata= T([0, 1, 2])([2.5,8,((z_random[2]+z_random[1])/2)+0.8])(housescalata)
var housetraslata2= T([0, 1, 2])([2.5,10,((z_random[2]+z_random[1])/2)+0.8])(housescalata)
var housetraslata3= T([0, 1, 2])([2.5,12,((z_random[2]+z_random[1])/2)+0.8])(housescalata)
//var house = T([0, 1, 2])([2.5,8,((z_random[2]+z_random[1])/2)])(STRUCT([house1,out,out2,out3,out4]))
DRAW(STRUCT([housetraslata,housetraslata2,housetraslata3]));
