...
var depth = 50/14.;
var raiser = 35.0/14.;
var step2D = SIMPLICIAL_COMPLEX([[0,0],[0,4+raiser],[depth,raiser],[depth,4+raiser]])([[0,2,1],[1,2,3]]);
var step3D = MAP([S0,S2,S1])(EXTRUDE([15])(step2D));
var ramp = STRUCT(REPLICA(14)([step3D,T([0,2])([depth,raiser])]));
var R_ramp= R([0,1])(PI/2)(ramp);

stair1 = T([0,1])([15+4,4+17+4+15])(R_ramp);
//DRAW(stair1);


//scalini primo piano
var step2D2 = SIMPLICIAL_COMPLEX([[0,0],[0,4+raiser],[depth,raiser],[depth,4+raiser]])([[0,2,1],[1,2,3]]);
var step3D2 = MAP([S0,S2,S1])(EXTRUDE([15])(step2D2));
var ramp2 = STRUCT(REPLICA(14)([step3D2,T([0,2])([depth,raiser])]));
var R_ramp2= R([0,1])(PI/2)(ramp2);

stair2 = T([0,1,2])([15+4,4+13,35])(R_ramp2);
//DRAW(stair2);

//scalini secondo piano
var step2D3 = SIMPLICIAL_COMPLEX([[0,0],[0,4+raiser],[depth,raiser],[depth,4+raiser]])([[0,2,1],[1,2,3]]);
var step3D3 = MAP([S0,S2,S1])(EXTRUDE([15])(step2D3));
var ramp3 = STRUCT(REPLICA(14)([step3D3,T([0,2])([depth,raiser])]));
var R_ramp3= R([0,1])(PI/2)(ramp2);

stair3 = T([0,1,2])([15+4,4+35+4+39,35+35])(R_ramp3);
//DRAW(stair3);

building = STRUCT([floor0,floor1,floor2,floor3,floor4,pillars,sud,ovest,est,nord,terra,window1,window2,window3,stair1,stair2,stair3])
DRAW(building);
